...
def test_update_first_contact(app):
    ...
    app.contact.update_first_contact(Contact(firstname="First update", middlename="Middle update", lastname="Last update",
                               ...
                               byear="2005", aday="14", amonth="June", ayear="1980", new_group="[none]",
